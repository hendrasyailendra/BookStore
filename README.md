## Description 
This is simple book store website using Java EE as REST API (backend), Angular (frontend), H2 (relational db), Intellij IDEA (Editor), Maven (Building tool), Wildfly (Application Server), JUnit & Arquillian (Testing Framworks), Swagger.
